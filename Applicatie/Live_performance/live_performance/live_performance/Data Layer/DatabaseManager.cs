...
namespace live_performance.Data_Layer
{
    public class DatabaseManager
    {
            ...
            public static OracleConnection Connection
            {
                get
                {
                    try
                    {
                        _connection = new OracleConnection("Data Source=(DESCRIPTION=(ADDRESS=(PROTOCOL=TCP)(HOST=fhictora01.fhict.local)(PORT=1521))(CONNECT_DATA=(SERVICE_NAME=fhictora))); User ID=dbi318334; PASSWORD = cQQBGJNsvk;");
                        _connection.Open();
                        return _connection;
                    }
                    catch (Exception ex)
